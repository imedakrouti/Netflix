...
<html lang="en">
  <head>
    ...
    {{-- noty css --}}
      <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/pluguin/noty/noty.css') }}">
       <script src="{{ asset('dashboard/pluguin/noty/noty.js') }}"></script>
       {{-- select2 css --}}
  ...
  <body class="app sidebar-mini">
    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
        ...
        <main class="app-content">
            ...
            @include('dashboard.partial._session')
